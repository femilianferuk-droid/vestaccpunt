...
PREMIUM_EMOJI_IDS = {
    ...
    'key': '6037142072850392123',
    'loading': '5345906554510012647',
    'auto': '5341800798608087014',
    'search': '5341613629154641024',
    'check': '5870633910337015697',
    'accept': '5774022692642492953',
    'cross': '5870657884844462243',
    'reject': '5774077015388852135',
    'alert': '5870717480744752620',
    'home': '5873147866364514353',
    'profile': '5870994129244131212',
    'phone': '5871479509017813521',
    'wallet': '5769126056262898415',
    'money': '5904462880941545555',
    'bank': '5903293462304105123',
    'price': '5904131987308236541',
    'crypto': '5260752406890711732',
    'star': '6041731551845159060',
    'location': '6042011682497106307',
    'country': '6041853663133452117',
    'box': '5884479287171485878',
    'tag': '5886285355279193209',
    'title': '5884142635193422107',
    'code': '5940433880585605708',
    'stats': '5870921681735781843',
    'broadcast': '6039422865189638057',
    'channel': '6039207980235022114',
    'add': '5771851822897566479',
    'back': '5893057118545646106',
    'prev': '5893087699213406234',
    'next': '5893057118545646107',
    'clock': '5983150113483134607',
    'buy': '5963103826075456248',
    'sell': '6032804403005732641',
    'market': '6032804403005732642',
    'hold': '6037249452824072507',
    'payout': '5904462880941545556',
    'list': '5884479287171485879',
    'seller': '5871479204245781345',
    'info': '6028435952299413210',
    'question': '6028576898927469814',
    'description': '5886833803013527089',
    'edit': '5870676941614354370',
    'media': '6035128606563241721',
    'photo': '6035128606563241722',
    ...
    'promo': '6032644646587338670',
    'file': '5870528606328852614',
    'download': '6039802767931871481',
    'session': '5870528606328852615',
    'json': '6035128606563241723',
}
...
def create_button(
    ...
    if icon and icon in PREMIUM_EMOJI_IDS:
        # Убираем ведущий обычный эмодзи, чтобы не дублировать с премиум-иконкой
...
def listings_keyboard(listings: list, page: int, has_next: bool, country: Optional[str] = None) -> InlineKeyboardMarkup:
    """
...
async def show_listings_page(callback: CallbackQuery, page: int = 0, country: Optional[str] = None):
    ...
    await send_media_message(callback, "buy_account", text, listings_keyboard(listings, page, has_next, country))
